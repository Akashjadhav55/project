const {flight: flightModel, hotel: hotelModel, site: siteModel, itinerary: itineraryModel, itineraryItem: itineraryItemModel} = require("../models") 
